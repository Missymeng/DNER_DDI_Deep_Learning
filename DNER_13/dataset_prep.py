...
# with open('./dataset/DDI13_test_medline_processed.csv', "wb") as f:
#     writer = csv.writer(f)
...
labels = ['O','B-drug','I-drug','B-drug_n','I-drug_n','B-brand','I-brand','B-group','I-group'] + ['<UNK>']
...
with open('./dataset/DDI13/DDI13_train_processed.csv', 'rb') as f:
    rd = csv.DictReader(f)
    for row in rd:
